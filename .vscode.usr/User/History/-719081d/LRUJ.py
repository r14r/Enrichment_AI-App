...
chat_and_content = [
    ...
    st.Page("views/chat_and_content/23_Headline_Teaser_Studio.py", title="📰 Headline & Teaser Studio"),
    st.Page("views/chat_and_content/24_SEO_Snippet_Maker.py", title="🔎 SEO Snippet Maker"),
    st.Page("views/chat_and_content/25_Product_Description_Booster.py", title="🛍️ Product Description Booster"),
    ...
    st.Page("views/chat_and_content/57_Slogan_Claim_Mixer.py", title="💡 Slogan & Claim Mixer"),
]
...
vision_and_media = [
    ...
    st.Page("views/vision_and_media/35_Video_Generator.py", title="🎥 Video Generator"),
    st.Page("views/vision_and_media/36_YouTube_Media_Studio.py", title="📥 YouTube Media Studio"),
    st.Page("views/vision_and_media/37_Instagram_Content_Studio.py", title="🎬 Instagram Content Studio"),
    ...
    st.Page("views/vision_and_media/43_Local_Video_Generator_with_MoviePy.py", title="🎬 Local Video Generator with MoviePy"),
]
...
analysis_and_rag = [
    ...
    st.Page("views/analysis_and_rag/44_Working_With_RAG.py", title="🔍 Working With RAG"),
    st.Page("views/analysis_and_rag/45_Working_With_Pipelines.py", title="🔧 Working With Pipelines"),
    st.Page("views/analysis_and_rag/46_RAG_Folder_Loader.py", title="📁 RAG Folder Loader"),
]

productivity_and_dev = [
    st.Page("views/productivity_and_dev/51_Sentiment_Tagging.py", title="😊 Sentiment Tagging"),
    st.Page("views/productivity_and_dev/53_Code_Review_Lite.py", title="💻 Code Review Lite"),
    st.Page("views/productivity_and_dev/54_Prompt_Tuner_AB.py", title="🎯 Prompt Tuner A/B"),
    st.Page("views/productivity_and_dev/56_Dockerfile_README_Generator.py", title="🐳 Dockerfile & README Generator"),
]
...
navigation = st.navigation(
    {
        ...
        "🧰 Produktivität & Dev": productivity_and_dev,
