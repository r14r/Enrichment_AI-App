...
Help you build AI products using the latest models.

| **Name** | **DisplayName** | **Publisher** | **InputTypes** | **Input/Output Context** | **Cost** (per 1M Tokens) | **Quality** (quality index; higher is better) | **Throughput** (output tokens per second; higher is better) | **Safety** (attack success rate; lower is better) | **LastUpdated** | **Notes** |
|--------|----------|---------------|---------------|--------------------------|---------------|---------------|---------------|---------------|----------------|--------------|
| gpt-5 | OpenAI gpt-5 | OpenAI | text, image | 200K / 100K | $3.6875 | 0.9058 | N/A | 4.1667% | 2025-08 | Designed for logic-heavy, multi-step tasks. |
| gpt-5-mini | OpenAI gpt-5-mini | OpenAI | text, image | 200K / 100K | $0.6875 | 0.8914 | N/A | N/A | 2025-08 | Lightweight version for cost-sensitive applications. |
| gpt-5-nano | OpenAI gpt-5-nano | OpenAI | text, image | 200K / 100K | $0.1375 | 0.8262 | N/A | N/A | 2025-08 | Optimized for speed, ideal for low-latency applications. |
| gpt-5-chat | OpenAI gpt-5-chat (preview) | OpenAI | text, image | 200K / 100K | $3.6875 | 0.8537 | N/A | N/A | 2025-08 | Advanced, natural, multimodal, context-aware conversations for enterprise apps. |
| o3-pro | o3-pro | OpenAI | text, image | 200K / 100K | $35.0 | 0.9104 | N/A | N/A | 2025-06 | o3 series: RL-trained for complex reasoning. o1-pro: more compute for better answers. |
| codex-mini | codex-mini | OpenAI | text, image | 200K / 100K | N/A | N/A | N/A | N/A | 2025-06 | Fine-tuned o4-mini for rapid, instruction-following in CLI workflows. |
| DeepSeek-R1-0528 | DeepSeek-R1-0528 | DeepSeek | text | 128K / 4K | $2.3625 | 0.8748 | 42.54 | N/A | 2025-05 | Improved reasoning, reduced hallucination, better function calling & vibe coding. |
| grok-3 | Grok 3 | xAI | text | 131K / 4K | $6.0 | 0.8461 | 23.84 | N/A | 2025-05 | xAI's debut model, pretrained for specialized domains (finance, healthcare, law). |
| grok-3-mini | Grok 3 Mini | xAI | text | 131K / 4K | $0.505 | 0.872 | 147.54 | N/A | 2025-05 | Lightweight model for logic-based tasks, trained on math and science. |
| o3 | OpenAI o3 | OpenAI | text, image | 200K / 100K | $3.5 | 0.8991 | 62.12 | 2.8333% | 2025-04 | Improved quality & safety over o1 with similar or better performance. |
| o4-mini | OpenAI o4-mini | OpenAI | text, image | 200K / 100K | $1.925 | 0.8864 | 51.83 | 4.0% | 2025-04 | Improved quality & safety over o3-mini with similar or better performance. |
| MAI-DS-R1 | MAI-DS-R1 | Microsoft | text | 128K / 4K | N/A | 0.8696 | N/A | 32.0% | 2025-04 | Microsoft post-trained DeepSeek-R1 to fill info gaps, improve harm protection, keeping R1 reasoning. |
| gpt-4.1 | OpenAI GPT-4.1 | OpenAI | text, image | 1M / 33K | $3.5 | 0.844 | 95.2 | N/A | 2025-04 | Outperforms gpt-4o in coding, instruction following, and long-context understanding. |
| gpt-4.1-mini | OpenAI GPT-4.1-mini | OpenAI | text, image | 1M / 33K | $0.7 | 0.8066 | 125.04 | N/A | 2025-04 | Outperforms gpt-4o-mini in coding, instruction following, and long-context handling. |
| gpt-4.1-nano | OpenAI GPT-4.1-nano | OpenAI | text, image | 1M / 33K | $0.175 | 0.6978 | 115.82 | N/A | 2025-04 | Gains in coding, instruction following, long-context handling with lower latency/cost. |
| mistral-medium-2505 | Mistral Medium 3 (25.05) | Mistral AI | text, image | 128K / 4K | $0.8 | 0.7662 | 42.82 | 53.6667% | 2025-05 | Advanced LLM with SOTA reasoning, knowledge, coding, and vision. |
| Phi-4-reasoning | Phi-4-Reasoning | Microsoft | text | 33K / 4K | $0.2188 | 0.7579 | 28.89 | N/A | 2025-04 | State-of-the-art open-weight reasoning model. |
| Phi-4-mini-reasoning | Phi-4-mini-reasoning | Microsoft | text | 128K / 4K | $0.1312 | 0.691 | 28.88 | N/A | 2025-04 | Lightweight math reasoning model for multi-step problems. |
| Llama-4-Scout-17B-16E-Instruct | Llama 4 Scout 17B 16E Instruct | Meta | text, image | 10M / 4K | $0.345 | 0.713 | 30.46 | N/A | 2025-05 | Excels at multi-document summarization, parsing user activity, and reasoning over codebases. |
| Llama-4-Maverick-17B-128E-Instruct-FP8 | Llama 4 Maverick 17B 128E Instruct FP8 | Meta | text, image | 1M / 4K | $0.615 | 0.79 | 48.53 | 15.3333% | 2025-04 | Great for precise image understanding & creative writing, high quality at lower price than Llama 3.3 70B. |
| cohere-command-a | Cohere Command A | Cohere | text | 131K / 4K | $4.375 | 0.7655 | 32.99 | 43.5% | 2025-06 | Highly efficient generative model for agentic and multilingual use cases. |
| gpt-4.5-preview | GPT-4.5 Preview | OpenAI | text, image | 131K / 16K | $93.75 | 0.7973 | N/A | N/A | 2025-02 | Largest, strongest general-purpose GPT model for diverse text/image tasks. |
| o3-mini | OpenAI o3-mini | OpenAI | text | 200K / 100K | $1.925 | 0.8658 | 127.75 | 7.0% | 2025-01 | o1 features with significant cost-efficiencies for high-performance scenarios. |
| DeepSeek-V3-0324 | DeepSeek-V3-0324 | DeepSeek | text | 128K / 4K | $1.9975 | 0.7521 | 60.21 | N/A | 2025-04 | Notable improvements over DeepSeek-V3 in reasoning, function calling, and code generation. |
| DeepSeek-R1 | DeepSeek-R1 | DeepSeek | text | 128K / 4K | N/A | N/A | N/A | N/A | 2025-01 | Excels at reasoning (language, science, coding) via step-by-step training. |
| computer-use-preview | computer-use-preview | OpenAI | text, image | 131K / 16K | N/A | N/A | N/A | N/A | 2025-03 | Model for Computer Use Agent in Responses API to control a browser and act on a user's behalf. |
| Phi-4-mini-instruct | Phi-4-mini-instruct | Microsoft | text | 128K / 4K | $0.1312 | 0.4429 | 41.46 | N/A | 2025-02 | 3.8B param SLM outperforming larger models in reasoning, math, coding, and function-calling. |
| Phi-4-multimodal-instruct | Phi-4-multimodal-instruct | Microsoft | audio, image, text | 128K / 4K | N/A | 0.4301 | 21.52 | N/A | 2025-06 | First small multimodal model with 3 modality inputs (text, audio, image), excelling in quality and efficiency. |
| Phi-4 | Phi-4 | Microsoft | text | 16K / 16K | $0.2188 | 0.7193 | 37.94 | 2.0% | 2025-06 | Highly capable 14B model for low latency scenarios. |
